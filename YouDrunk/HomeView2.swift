...
struct HomeView: View {
    ...
    @State var showingNewDrinkView = false
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                NavigationLink("", destination: ListDrinkView(), isActive: $showingNewDrinkView)
...
struct panicView: View {
    ...
    @State private var panic_color: Color = Color("Panic")
